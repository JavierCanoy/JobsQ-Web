    ...
    <>
      ...
      <div className=" flex justify-end gap-32      ">
        <div className="ml-10 mx-20 px-2  ">
          <div className=" pt-64">
            <p className="text-xl uppercase pl-10 text-gray-400 font-OpenSans font-light">
              Our Goal
            </p>
      ...
      <div className="flex justify-around pt-40 mt-40 ">
        ...
        <div className="flex  self-end text-lg font-semibold">
          <Link href="/">
            <button className="pr-20  text-red-500 font-OpenSans  font-semibold">
              PREV
            </button>
          </Link>
          <Link href="/">
            <button className="px-2  text-gray-300 font-OpenSans  font-semibold">
              NEXT
            </button>
          </Link>
          <Link href="/">
        ...
        <div className=" text-center pt-16">
          ...
          <div className=" flex justify-center pt-16 ">
            <div className="flex  self-end text-lg font-semibold gap-32">
              <Link href="">
                <button className="  text-gray-300 font-OpenSans  font-semibold ">
                  PREV
                </button>
              </Link>
              <Link href="">
