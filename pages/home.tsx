    ...
    <>
      <div>
        ...
        <div className="  px-80  mx-20  pt-10">
          <div className=" ">
            <h1 className=" text-5xl font-bold pt-20 text-left">
              We do great things <br /> together
            </h1>
            <div className=" ">
              <p className="   text-xl text-left pt-20 text-gray-400">
                MaboloTech IT Solutions was established in 2020 amidst the
                COVID-19 pandemic, <br /> aiming to help friends and former
                colleagues affected by job loss. We understand the <br />{" "}
                difficulties of navigating uncertain times and strive to provide
                affordable software
                <br />
                development services and IT solutions to individuals and
                businesses locally and <br /> internationally.
                <br />
                Our team of experienced and talented professionals is passionate
                about delivering
                <br />
                innovative and customized technology solutions. We dedicate to
                helping our clients <br /> achieve their goals and stay ahead of
                the competition through cutting-edge <br /> technologies and
                processes.
                <br />
                At MaboloTech IT Solutions, every project is unique and requires
                a personalized <br />
                ...
                needs. Whether it's
                <br /> developing a new website or improving the efficiency of
                your existing systems, we
        ...
        <div>
          ...
          <div className=" flex justify-center pt-28 pb-10">
            <p className=" text-left text-xl text-gray-400">
              ...
              solution for your IT needs. Contact us today to see how we can
              help you
              <br /> achieve your goals.
            </p>
          </div>
          <div className="image flex justify-center gap-10 pt-10 pb-24 ">
            <div className="">
              <Image
                src={team}
                alt="Myimage"
        ...
        <div className="main p-24 bg-gradient-to-t from-[#F35A43] to-[#C1272D]">
          ...
          <div className=" flex   gap-10 justify-center text-white pt-20 ">
            <div className="bg-gradient-to-r from-[#F5B596] to-[#EB3449] p-4 rounded-lg">
              ...
              <button className=" text-base font-semibold flex">
                Know more
                <svg
                  className="w-5 h-5  "
                  fill="currentColor"
        ...
        <div>
          ...
          <div className="flex justify-center gap-2 pt-20 pb-32 mx-4">
            <div>
              <Image src={pic} alt="Myimage" height={432} width={550} />
              <div className=" pt-4">
