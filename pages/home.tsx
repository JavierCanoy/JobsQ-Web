      ...
      <Layout>
        ...
        <div className="  px-80  mx-20  pt-10">
          ...
          <p className="   text-xl font-OpenSans text-left pt-24 pb-20 text-gray-400">
            ...
            pandemic, <br /> aiming to help friends and former colleagues
            affected by job loss. We understand the <br /> difficulties of
            navigating uncertain times and strive to provide affordable software
            <br />
            ...
            helping our clients <br /> achieve their goals and stay ahead of the
